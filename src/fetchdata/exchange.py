...
from typenums.constants import (
...
from freqtrade.util.datetime_helpers import  dt_ts, format_ms_time
...
class Exchange:
    ...
    def name(self) -> str:
        ...
        return self._api.name # type: ignore

    @property
    def id(self) -> str:
        """exchange ccxt id"""
        return self._api.id # type: ignore
