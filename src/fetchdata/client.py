...
from typenums import MarketType,TimeFrame
from communication import CommunicationProtocol
from data.serialize import deserialize_dataframe
from .method_invoke import create_invoke_method
logger = logging.getLogger(__name__)

         

class Clinet(ExchangeABC[pl.DataFrame]):
    @staticmethod
    ...
    async def  send(self, method: MethodID, params: dict) -> bytes:
        ...
        return await self.request.send(invoke, serializer=Clinet.serailize)
